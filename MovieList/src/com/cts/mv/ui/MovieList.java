...
public class MovieList {
		...
		try {
			...
			if(movies.size()==0) {
				System.out.println("No movies to display");
					...
					Collections.sort(movies, new com.cts.mv.service.MovieComparatorHero());
					for(Movie m : movies) {
						System.out.println(m);
					}
					System.out.println("------------------------------------------------------------------------------------------------------------");
	...
	private static void doDate() {
		...
		try {
			...
			if(movies.size()==0) {
				...
				Collections.sort(movies, new com.cts.mv.service.MovieComparatorDate());
		...
		try {
			...
			if(movies.size()==0) {
				System.out.println("No movies to display");
					...
					Collections.sort( movies,new com.cts.mv.service.MovieComparatorName());
	...
	private static void doCollection() {
		...
		Collections.sort(movies, new com.cts.mv.service.MovieComparatorCollection());
		for(Movie movie : movies) {
			System.out.println(movie);
			}
		System.out.println("------------------------------------------------------------------------------------------------------------");
